...
fn parse_participants_data(cursor: &mut Cursor<Bytes>) -> ParticipantData {
    ...
    let team_id = match cursor.get_u8() {
        ...
        8 | 93 => Team::McLaren,
        9 | 94 => Team::AlfaRomeo,
        42 | 70 | 110 => Team::ArtGP,
        43 | 71 | 114 => Team::Campos,
        44 | 72 | 108 => Team::Carlin,
        45 => Team::SauberJuniorCharouz,
        46 | 74 | 113 => Team::Dams,
        47 | 75 | 107 => Team::UniVirtuosi,
        48 | 76 | 111 => Team::MPMotorsport,
        49 | 77 | 106 => Team::Prema,
        50 | 78 | 116 => Team::Trident,
        51 => Team::Arden,
        73 | 112 => Team::Charouz,
        79 | 115 => Team::BWT,
        80 | 109 => Team::Hitech,
